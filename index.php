...
<html lang="en" class="h-100">
   ...
   <body class="h-100" data-spy="scroll" data-target=".navbar" data-offset="70">
      ...
      <div class="hl-div" id="hld">
         <div class="d-flex h-100 text-center">
            <div class="col-md-8 offset-md-2 col-12" style="background-color: #f0ffffb5; padding: 80px 50px 50px 50px;">
               ...
               <h3 class="title">Human Library Dhaka</h3>
               <p class="text-justify">
         ...
         <div class="row text-center">
            ...
            <div class="col-md col-12">
               <div class="card card-shadow">
                  ...
                  <div class="card-footer">
                     <a href="#contact_us" class="card-btn a-color">Email us</a>
                  </div>
               </div>
            </div>
         </div>
                  ...
                  <div class="">
                     ...
                     <form id="email_form" action="#">
                        ...
                        <div class="row">
                           ...
                           <div class="col-10">
                              <p id="mail_status" class="text-right"></p>
                           </div>
                        </div>
                     </form>
                  </div>
      ...
      <div class="text-center">
        <small>&copy; <script>var d = new Date(); document.write(d.getFullYear())</script> Human Library Dhaka. <span>All Rights Reserved.</small>
      </div>
      <!-- Optional JavaScript -->
      <!-- jQuery library -->
